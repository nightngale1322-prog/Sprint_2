...
class Football(Results):
    ...
    def number_of_wins (self,victories):
        return f'Футбольных побед: {self.victories}'
    
    def number_of_draws(self, draws):
        return f'Футбольных ничьих: {self.draws}'
    
    def number_of_losses(self, losses):
...
for team in (football_team, hockey_team):
    print(team.number_of_wins(team.victories))
    print(team.number_of_draws(team.draws))
    print(team.number_of_losses(team.losses))
